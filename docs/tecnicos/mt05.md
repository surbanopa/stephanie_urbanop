...
En primer lugar, descargué el modelo 3D propuesto, lo guarde como OBJ para abrirlo en el software. Seleccioné como equipo de impresión el modelo Bambu Lab P1S, asegurándome de que el perfil de máquina coincidiera con la impresora disponible. Posteriormente, realicé un ajuste de escala, reduciendo el tamaño del modelo para optimizar el tiempo de impresión y el consumo de material.
![](../images/MT05/Diapositiva5.JPG)

![](../images/MT05/Diapositiva6.JPG)

Uno de los pasos más importantes fue la orientación de la pieza. Modifiqué su posición en el eje para que pudiera apoyarse correctamente sobre la base, evitando voladizos críticos Además active la opción de soporte como normal y aumente el relleno de la pieza. Si la impresora está conectada se puede enviar directamente a imprimir, de lo contrario, se manda guarda como GCODE.
