...
Dentro de la práctica que realizamos en el fablab ESAN, Jorge nos presentó un ejercicio adicional que nos permitió probar un sistema que integraba un motor servo, un driver para control de motor DC, una pantalla LCD y un sensor infrarojo.

Al detectar proximidad el sensor infrarojo, el motor giraba y en la pantalla LCD aparecia un mensaje de encendido y apagado.

![](../images/EJ6.jpg)

##### Reflexión

El aporte de la electrónica permite llevar la experiencia del usuario a un nuevo nivel, resolviendo problemáticas a diferentes escalas, de manera relativamente fácil (si sabes programar) y accesible. Me parece increíble como se puede dotar de distintas caracteristicas con las conexiones adecuadas. Entendiendo la lógica de programar un comando de programación, sin duda se puede llegar a resultados muy interesantes.

Cuando nos tocó experimentar en el labotorio, al inicio fue retador ya que es en tema nuevo con conceptos puntuales a tener en cuenta para entender el funcionamiento detrás de las conexiones que se requiere realizar. La guía de forma presencial fue de bastante ayuda para poder realizar las pruebas de los ejercicios propuestos y la dinámica nos ayudo a identificar componentes más rápidamente. Creo que aún me falta explorar más pero siente satisfactorio cuando luego de todo el cableado y la programación en Arduino se observa como funciona la acción que se tenia pensado. Es como magia.